    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <section className="relative h-screen bg-gradient-to-b from-gray-600 to-gray-800">
        ...
        <div className="relative z-10 flex flex-col justify-end items-start h-full max-w-7xl mx-auto px-8 pb-20 pr-0">
          <h1 className="text-[#ffffff] mb-16 max-w-4xl leading-tight">
      ...
      <section className="py-20 bg-[#ffffff]">
        <div className="max-w-7xl mx-auto px-8">
          <h2 className="text-[#000000] mb-16">
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            ...
            <section id="problem" className="py-20 bg-[#fafafa] -mx-8 px-8">
              <div>
                <h2 className="text-[#000000] mb-8">The Problem</h2>
            ...
            <section id="hypothesis" className="py-20 relative">
              ...
              <div className="relative z-10 text-center">
                <h2 className="text-[#ffffff] mb-4 text-left">Our Hypothesis: Extended Reality Can Bridge The Gap</h2>
                <p className="text-[#ffffff] mb-16 text-left mt-0">What Is Extended Reality?</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                  <Card className="bg-[#ffffff] bg-opacity-20 border-none">
                    <CardContent className="p-6">
                      ...
                      <h3 className="text-[#ffffff] mb-2">Virtual Reality</h3>
                  ...
                  <Card className="bg-[#ffffff] bg-opacity-20 border-none">
                    <CardContent className="p-6">
                      ...
                      <h3 className="text-[#ffffff] mb-2">Augmented Reality</h3>
                  ...
                  <Card className="bg-[#ffffff] bg-opacity-20 border-none">
                    <CardContent className="p-6">
                      ...
                      <h3 className="text-[#ffffff] mb-2">Mixed Reality</h3>
                ...
                <div className="text-left">
                  <h3 className="text-[#ffffff] mb-8">Why Explore Extended Reality?</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="space-y-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <h4 className="text-[#ffffff] mb-2">Safety</h4>
                          <p className="text-[#ffffff] text-sm">
                      ...
                      <div className="flex items-start space-x-4">
                        <div className="w-6 h-6 bg-[#ffd700] rounded-full flex-shrink-0 mt-1"></div>
                        <div>
                          <h4 className="text-[#ffffff] mb-2">Comfort</h4>
                          <p className="text-[#ffffff] text-sm">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start space-x-4">
                        <div className="w-6 h-6 bg-[#ffd700] rounded-full flex-shrink-0 mt-1"></div>
                        <div>
                          <h4 className="text-[#ffffff] mb-2">Portability</h4>
                          <p className="text-[#ffffff] text-sm">
                      ...
                      <div className="flex items-start space-x-4">
                        <div className="w-6 h-6 bg-[#ffd700] rounded-full flex-shrink-0 mt-1"></div>
                        <div>
                          <h4 className="text-[#ffffff] mb-2">Flexibility</h4>
                          <p className="text-[#ffffff] text-sm">
            ...
            <section id="users" className="py-20 bg-[#ffffff] -mx-8 px-8">
              <div>
                <h2 className="text-[#000000] mb-8">Understanding Our Users</h2>

                <div className="space-y-12">
                  {/* Who Is This Experience For */}
                  <div>
                    <h3 className="text-[#000000] mb-4">Who Is This Experience For?</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                      <Card className="border-2 border-gray-300">
                        <CardContent className="p-6 text-center">
                          ...
                          <h4 className="text-[#000000]">Small Plant Owners</h4>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="border-2 border-gray-300">
                        <CardContent className="p-6 text-center">
                          ...
                          <h4 className="text-[#000000]">Factory Operators</h4>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="border-2 border-gray-300">
                        <CardContent className="p-6 text-center">
                          ...
                          <h4 className="text-[#000000]">Students</h4>
                        </CardContent>
                      </Card>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="text-[#000000] mb-4">How Do Our Users Feel About XR?</h3>
                    ...
                    <p className="text-[#000000] mb-2 text-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                      <div>
                        <h4 className="text-[#6e4aff] mb-2">What we built:</h4>
                        <p className="text-[#000000] mb-2">A virtual, interactive robot in:</p>
                      ...
                      <div>
                        <h4 className="text-[#6e4aff] mb-2">Who we tested with:</h4>
                        <p className="text-[#000000] mb-2">2 groups:</p>
                        <ul className="text-gray-600 text-sm space-y-1">
                          <li>• Ages 30-40</li>
                          <li>• Ages 40-50</li>
                        </ul>
                      ...
                      <div>
                        <h4 className="text-[#6e4aff] mb-2">What we measured:</h4>
                        <ul className="text-gray-600 text-sm space-y-1">
            ...
            <section id="tackling" className="py-20 bg-[#fafafa] -mx-8 px-8">
              <div>
                <h2 className="text-[#000000] mb-8">Tackling An Ambiguous Problem</h2>
                <p className="text-gray-600 mb-8 leading-relaxed">
                ...
                <div className="space-y-12">
                  ...
                  <div>
                    ...
                    <div className="bg-[#1e1e1e] text-[#ffffff] p-6 rounded-lg">
                      <h4 className="text-[#000000] mb-4">What should the VR environment look and feel like?</h4>
            ...
            <section id="writing" className="py-20 bg-[#ffffff] -mx-8 px-8">
              <div>
                <h2 className="text-[#000000] mb-8">Writing An Impactful Story</h2>
                <p className="text-gray-600 mb-8 leading-relaxed">
                ...
                <div className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                      ...
                      <div className="text-center">
                        <Image
                          ...
                          className="w-full h-auto rounded-lg mb-4"
                        />
                        <h4 className="text-[#000000] mb-2">Learning</h4>
                  ...
                  <div>
                    ...
                    <div className="bg-[#1e1e1e] text-[#ffffff] p-6 rounded-lg">
                      <h4 className="text-[#000000] mb-4">Problem-solving in VR</h4>
                      <p className="text-sm mb-4 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[#000000] mb-4">Creating the VR problem-solving task</h3>
                    <p className="text-gray-600 mb-8 leading-relaxed">
                  ...
                  <div className="mt-12 pt-12 border-t border-gray-200">
                    ...
                    <h3 className="text-[#000000] mb-4">Why Chocolate?</h3>
                    <p className="text-gray-600 mb-8 leading-relaxed">
      ...
      <div className="bg-[#1e1e1e] text-white">
        ...
        <div className="py-20">
          <div className="max-w-7xl mx-auto px-8">
            <h2 className="text-center mb-16">The Solution</h2>
            ...
            {/* Key Decisions */}
            <div className="mb-16">
              <h3 className="text-center mb-12">Key Decisions For The Problem-Solving Scene</h3>

              {/* First Decision */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                <div>
                  <h4 className="mb-4">Fitting An End-To-End Process Into A Confined Space</h4>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div>
                  <h4 className="mb-4">Displaying Liquid Chocolate</h4>
                  <p className="text-gray-300 mb-4 leading-relaxed">
            ...
            <div className="mb-16">
              ...
              <div className="mb-16">
                <h3 className="text-center mb-12">Key Decisions For The Robotic Work Station</h3>

                {/* Combined Simple + Custom App Section */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                  <div>
                    <h4 className="mb-4">Simple, Right? Not Really...</h4>
                    <p className="text-gray-300 mb-4 leading-relaxed">
                    ...
                    <h4 className="mb-4">We built a custom app to solve this problem</h4>
                    <p className="text-gray-300 mb-4 leading-relaxed">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                  <div>
                    <h4 className="mb-4">Allowing For Easy Content Changes In The Future</h4>
                    <p className="text-gray-300 mb-4 leading-relaxed">
              ...
              <div className="mb-16">
                <h3 className="text-center mb-12">Getting AI-Powered Personalized Assistance</h3>
                ...
                <div>
                  <h3 className="text-center mb-12">Key Decisions For ARMbot</h3>

                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    <div>
                      <h4 className="mb-4">Trained To Ask Questions</h4>
                      <p className="text-gray-300 leading-relaxed">
                    ...
                    <div>
                      <h4 className="mb-4">Finding The Right "Offering"</h4>
                      <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-[#ffffff] py-20">
          <div className="text-center mb-16">
            <div className="inline-block bg-white px-8 py-4">
              <h2 className="text-[#6e4aff]">The Impact</h2>
            </div>
          </div>
          ...
          <div className="bg-[#6e4aff] w-full">
            <div className="max-w-7xl mx-auto px-8 py-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                <div>
                  <h3 className="mb-6 text-white">ARM Anticipates That This Experience Will Drastically Improve Their Ability To Serve Their Audiences.</h3>
              ...
              <div className="mb-16">
                <h3 className="mb-6 text-white">Measuring Impact And Looking Forward</h3>
                  ...
                  <div className="bg-black rounded-lg p-6 flex items-center space-x-6">
                    <div className="w-24 h-16 bg-[#ffd700] rounded flex items-center justify-center flex-shrink-0">
                      <svg className="w-8 h-8 text-black" fill="currentColor" viewBox="0 0 20 20">
                        <path
                          fillRule="evenodd"
                          d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.9\
